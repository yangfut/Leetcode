...
| 1403 | [Minimum Subsequence in Non-Increasing Order](https://leetcode.com/problems/minimum-subsequence-in-non-increasing-order/) | Greedy, Sort | Easy | [python](/python/452_Minium-Number-of-Arrows-to-Burst-Balloons.py ) | O\(N) | O\(1\) |
